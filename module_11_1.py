...
"""
Модуля requests.
Используется для получения данных о курсах валют с сайта на текущую дату и 
записывает полученные данные в переменную r в формате json.
"""
...
"""
Модуль pandas.
Позволяет Сохранить полученные курсы валют в файле .xlsx.
"""
